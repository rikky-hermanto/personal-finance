...
Prototype yang jadi acuan: `Journey & Cashflow.html` + `pf-chat.jsx` + `pf-app.jsx` (project design "Personal Finance"). Keputusan desain: **Opsi A — slide-over panel**, bukan halaman `/chat` di kolom Recent maupun split 50/50.
