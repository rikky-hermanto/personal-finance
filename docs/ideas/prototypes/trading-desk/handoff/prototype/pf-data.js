...
window.PF = (function () {
  ...
  const TIER_META = {
    L1: { label: 'Foundations', deeplink: '/cashflow/overview',  module: 'Cashflow' },
    L2: { label: 'Defense',     deeplink: '/assets/accounts',    module: 'Assets' },
    L3: { label: 'Growth',      deeplink: '/investment/overview', module: 'Investment' },
    L4: { label: 'Freedom',     deeplink: '/investment/holdings', module: 'Investment' },
    L5: { label: 'Legacy',      deeplink: '/assets/overview',    module: 'Assets' },
  };
