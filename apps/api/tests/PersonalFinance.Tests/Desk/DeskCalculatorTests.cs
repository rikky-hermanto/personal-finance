...
public class DeskCalculatorTests
{
    ...
    private static NavChainInputDto ChainInput(MandateParamsDto mandate, decimal openRisk = 0m, string regime = "Normal") =>
        new(
            TentativeNav: 1_000_000_000m,
            ReconciledNavExclStockbit: 970_000_000m,
            LegacyMv: 900_000_000m,
            StockbitDuplicateCash: 30_000_000m,
            StockbitResolution: "exclude",
            OpenRisk: openRisk,
    ...
    public void EvaluateGate_AddingToLosingLegacyPosition_Blocks()
    {
        ...
        {
            new(Guid.NewGuid(), "Mandiri", "BBRI", "IDX Stock", null, 174000, 1740, 4270.78m, null, 2930, null,
                743115720, 509820000, -233295720, -31.39m, 52.12m, "Legacy / Unclassified", null, false, false),
        };
